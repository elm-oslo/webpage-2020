...
- [@OsloElmDays](https://twitter.com/osloelmdays)
...
viewCodeOfConduct =
    let
        cocTxt =
            """
## Code of Conduct
All delegates, speakers, sponsors and volunteers are required to agree with the following code of conduct.
...
Conference staff can be identified by a clearly marked "STAFF" conference badge.
